  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      ...
      <div class="cardStyle">
		  ...
		  <div class="inputDiv">
			<b><label style="font-size:14px;" class="inputLabel" for="cat">Enter Category Name</label></b><br><br>
		  ...
		  <div class="inputDiv">
			<b><label style="font-size:14px;" class="inputLabel" for="text">Descripton</label></b><br><br>
		  ...
		  <div class="buttonWrapper">
		    ...
		    <span style="color:blue">CREATE CATEGORY</span>
		    </button>
		  </div>	
		</form>
      </div>
