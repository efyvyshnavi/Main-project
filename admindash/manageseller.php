              ...
              <div class="card recent-sales overflow-auto">
                ...
                <div class="filter">
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <?php $query=mysqli_query($conn,"select sellerreg.sellerid,sellerreg.fname,sellerreg.lname,login.email,sellerreg.phoneno,sellerreg.logid,sellerreg.status,sellerreg.creationDate from sellerreg join login on login.logid=sellerreg.logid and sellerreg.status='2'");
$cnt=1;
while($row=mysqli_fetch_array($query))
{
?>									
