  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      <div class="row">
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  ...
                  <div class="inputDiv">
			<b><label class="inputLabel" for="cat"> Category</label><br><br>
		  ...
		  <br><br>
		  <div class="inputDiv">
			<label class="inputLabel" for="cat">Enter SubCategory Name</label><br><br>
			<input style="font-size:15px;height:40px"type="text"name="subcategory"size="35" id="subcategory"required pattern="[a-zA-Z][a-zA-Z ]+[a-zA-Z]$"oninvalid="this.setCustomValidity('Enter a valid Subcategory Name')"
		  ...
		  <div class="buttonWrapper">
			...
			<span style="color:blue">CREATE SUBCATEGORY</span>
			</button>
		  </div>	
		</form>
</div>
