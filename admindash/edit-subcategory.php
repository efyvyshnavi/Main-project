...
?>
      ...
      <div class="inputDiv">
      <b><label class="inputLabel" for="subcate"style="font-size:16px;">Enter SubCategory Name</label></b><br><br>
			<input type="text"name="subcate" style="height:50px" size="28"id="subcate"value="<?= $row['subcategory'] ?>" required>
		  </div>
          <br><br>
		  <div class="buttonWrapper">
			<button type="submit" id="su"name="su">
			  <span style="color:blue">UPDATE SUBCATEGORY</span>
			</button>
		  </div>
		</form>
</div>
