...
<?php $query=mysqli_query($conn,"select sellerreg.sellerid,sellerreg.fname,sellerreg.lname,login.email,sellerreg.phoneno,sellerreg.logid,sellerreg.status,sellerreg.creationDate,login.status from login join sellerreg on login.logid=sellerreg.logid AND sellerreg.status=1");
$cnt=1;
