...
?>
	<div class="cardStyle">
		  ...
		  <div class="inputDiv">
			&nbsp&nbsp&nbsp<b><label class="inputLabel" for="cat">Enter Category Name</label></b><br><br>
			<input type="text"rows="2" size="48"name="category" id="category"value="<?= $row['categoryName'] ?>" required>
		  </div>
		  <br><br>
		  <div class="inputDiv">
	     <b><label class="inputLabel" for="text">Descripton</label></b><br><br>
      
    &nbsp&nbsp
           
	  <textarea class="span8" id="description"name="description"rows="4" cols="50" ><?= $row['categoryDescription'] ?></textarea>
	  </div>
      <br><br><br>
